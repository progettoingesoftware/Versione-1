...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		 ...
		 * In questo caso vengono estrapolate sia la RaccoltaADati sia l'AnagraficaFruitori e l'AnagraficaOperatori, venendo salvate nelle variabili opportune.
		...
		/**
		 * L'operazione di salvataggio prevede la costruzione di una nuova RaccoltaDati attraverso i parametri AnagraficaFruitori ed AnagraficaOperatori e l'aggiornamento del file in gestoreRisorse
		 */
		System.out.println(MSG_SALVA);
		rd = new RaccoltaDati(af, ao);
