...
public class AnagraficaFruitori 
{
    ...
    /**
     * Metodo che verifica se l'utente, identificato tramite lo username e la password, Ã¨ presente nell'elenco dei fruitori giÃ  iscritti
     * 
     * @param u : username identificativo del fruitore
     * @param p : password del fruitore
     * 
     * @return boolean : true se l'utente Ã¨ giÃ  presente nell'elenco dei fruitori
     */
