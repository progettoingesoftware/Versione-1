...
/**
 * Questa classe contiene i dati dei vari fruitori e permette il controllo e la
...
public class AnagraficaFruitori extends Anagrafica implements Serializable 
{
	...
	/**
	 * Metodo che verifica se il fruitore che intende iscriversi ha
	 * contemporaneamente lo stesso nome, lo stesso cognome e la stessa data di
	 * nascita di almeno uno dei fruitori già iscritti
	 * 
	 * Pre : elenco != null
	 * 
	...
	/**
	 * Metodo che verifica se il fruitore che intende iscriversi ha lo stesso
	 * username di almeno uno dei fruitori gia' iscritti
	 * 
	 * Pre : elenco != null
	 * 
	...
	/**
	 * Metodo che verifica se la data corrente sia successiva rispetto alla data di
	 * scadenza del servizio prevista per uno specifico fruitore; in tal caso
	 ...
	 * stringa descrittiva contenente l'elenco ordinato dei vari fruitori
	 * 
	 * Pre : elenco != null
	 * 
